  ...
  return (
    <div className="flex w-full flex-col items-center">
      <div className="mt-12 flex w-full max-w-460 flex-col gap-y-4 md:grid md:aspect-93/27 md:grid-cols-24 md:grid-rows-4">
        <h1 className="lg:text-test-step-7 text-mobile-step-8 col-start-1 row-start-1 row-end-2 leading-[92%] font-extrabold lg:col-end-12">
          ABOUT
        </h1>
        <h1 className="lg:text-test-step-7 text-mobile-step-8 col-start-1 row-start-2 row-end-3 leading-[92%] font-extrabold lg:col-end-7">
          DNM
        </h1>
        <div className="col-start-10 col-end-25 row-start-3 row-end-5 lg:col-start-7 lg:col-end-19 lg:row-start-2 lg:px-8">
          <img
        ...
        <div className="order-5 col-end-25 row-start-2 flex-col md:order-0 md:col-start-11 md:row-end-3 lg:col-start-19 lg:row-end-5 lg:flex">
          ...
          <div className="mt-8 flex h-full flex-col gap-2 font-medium">
            <h2 className="text-step-2 leading-[92%] font-extrabold max-md:text-3xl">
              Our Philosophy
            </h2>
        ...
        <div className="lg:text-test-step--2 text-mobile-step--1 col-start-1 col-end-9 row-start-3 row-end-5 flex flex-col font-medium lg:col-end-7">
          <h3 className="my-auto leading-[92%] font-semibold max-md:mt-8 max-md:text-3xl max-md:font-extrabold">
